...
$query = "SELECT * FROM alternatif LIMIT $limit OFFSET $offset";
$result = $conn->query($query);

// Total records for pagination
$total_query = "SELECT COUNT(*) as total FROM alternatif";
        ...
        <div class="add-atf">
            ...
            <form action="create.php" method="POST" class="form-container">
                <div class="form-group">
                    ...
                    <input type="text" id="nama" name="nama" placeholder="Masukkan Nama Kandidat" required>
                </div>
                <button type="submit" class="btn-save text-sm">Simpan</button>
            </form>

            <h2 class="font-bold text-xl mt-4">Data Alternatif</h2>
            <table class="table">
                <thead>
                    <tr>
                        <th>No</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td data-label="Alternatif"><?= $row['nama']; ?></td>
